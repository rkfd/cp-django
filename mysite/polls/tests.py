...
class QuestionModelTests(TestCase):
  ...
  def test_was_published_recently_with_old_question(self):
    '''
    was_piblished_recently() returns False for questions whose pub_date is older than 1 day
    '''
...
class QuestionDetailViewTests(TestCase):
  def test_future_question(self):
    ...
    '''
    future_question = create_queston(question_text='Future question.', days=5)
  ...
  def test_past_question(self):
    ...
    '''
    past_question = create_queston(question_text='Past Question.', days=-5)
